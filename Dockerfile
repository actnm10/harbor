...
COPY --chown=node:node server.js lib.js admin.js settings.js storage.js preflight.js preview.js preview-worker.js preview-spreadsheet.js presentation-preview.js ./

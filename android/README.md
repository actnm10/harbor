...
1. Install the supplied `harbor-android-0.1alpha.apk` on Android **10 or newer**. Android may ask you to allow installation from the app you opened the APK with.
